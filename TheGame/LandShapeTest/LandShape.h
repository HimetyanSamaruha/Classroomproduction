...
public:
	...
	//箱
	bool IntersectBox(const Box& box, DirectX::SimpleMath::Vector3* inter);
	...
	//その場しのぎ
	void SetTrans(DirectX::SimpleMath::Vector3& trans) { m_Obj.SetTranslation(trans); }
	void SetRot(DirectX::SimpleMath::Vector3& rot) { m_Obj.SetRotation(rot); }
